...
public final class Greeter3Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.__gRPCServer.HelloWorldClientStreamProto.HelloRequest,
      com.example.__gRPCServer.HelloWorldClientStreamProto.HelloReply> getHelloWorldClientStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HelloWorldClientStream",
      requestType = com.example.__gRPCServer.HelloWorldClientStreamProto.HelloRequest.class,
      responseType = com.example.__gRPCServer.HelloWorldClientStreamProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.__gRPCServer.HelloWorldClientStreamProto.HelloRequest,
      com.example.__gRPCServer.HelloWorldClientStreamProto.HelloReply> getHelloWorldClientStreamMethod() {
    io.grpc.MethodDescriptor<com.example.__gRPCServer.HelloWorldClientStreamProto.HelloRequest, com.example.__gRPCServer.HelloWorldClientStreamProto.HelloReply> getHelloWorldClientStreamMethod;
    if ((getHelloWorldClientStreamMethod = com.example.__gRPCClient.grpc.java.Greeter3Grpc.getHelloWorldClientStreamMethod) == null) {
      synchronized (com.example.__gRPCClient.grpc.java.Greeter3Grpc.class) {
        if ((getHelloWorldClientStreamMethod = com.example.__gRPCClient.grpc.java.Greeter3Grpc.getHelloWorldClientStreamMethod) == null) {
          com.example.__gRPCClient.grpc.java.Greeter3Grpc.getHelloWorldClientStreamMethod = getHelloWorldClientStreamMethod =
